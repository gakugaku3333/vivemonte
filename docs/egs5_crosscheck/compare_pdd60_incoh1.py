...
"""Compare the INCOH=1 EGS5 PDD/OCR run (docs/egs5_crosscheck/plan_residual_check.md
Step 1) against the existing ChatCarlo result. Mirrors the methodology documented in
pdd60_NOTES.md (mass_g = bin_volume_cm3 * RHO_EGS5=1.001, KEV_PER_G_TO_GY constant
identical to the ChatCarlo-side script) used for the INCOH=0 (v1) comparison.
"""
import re, json, math

EGS5_OUT = "/Users/oishifamily/Projects/viveMonte/docs/egs5_crosscheck/pdd60_phantom_incoh1/egs5job.out"
...
import csv
with open("/Users/oishifamily/Projects/viveMonte/docs/egs5_crosscheck/pdd60_phantom_incoh1/comparison_table.csv", "w", newline="") as f:
    w = csv.writer(f)
