...
!     both water regions, matching the INCOH=1 PEGS5 data generated
!     above (PEGS5's INCOH=1 alone only makes S(q) tables available;
!     it does not force incohr on by itself -- see pdd60_phantom_incoh1.f).
...
160   format(/' Phantom run 8M (30x30x20 cm water, front layer scored)'/
     *        ' ncase=',I10/
